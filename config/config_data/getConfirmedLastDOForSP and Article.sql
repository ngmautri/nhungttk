/* Last Confirmed DN Items for SP and Article*/

select
mla_delivery_item_confirmed_1.id,
mla_delivery_item_confirmed_1.article_id,
mla_delivery_item_confirmed_1.sparepart_id,


mla_delivery_item_confirmed_1.delivered_quantity,
mla_delivery_item_confirmed_1.price,
mla_delivery_item_confirmed_1.currency,
mla_delivery_item_confirmed_1.last_status_on,

mla_delivery_item_confirmed_1.vendor_name,
mla_delivery_item_confirmed_1.vendor_id



from /* Confirmed DN Items*/
(
...
left join /*mla_last_confirmed_article_dn*/
(
/* article, sparepart last confirmed DO */
select
  	max(mla_delivery_item_confirmed_1.last_status_on) as max_last_status_on,

    mla_delivery_item_confirmed_1.article_id,
	concat(mla_delivery_item_confirmed_1.article_id,'+++',max(mla_delivery_item_confirmed_1.last_status_on)) as max_article_id_dn_last_confirmed_key,
    
    mla_delivery_item_confirmed_1.sparepart_id,
	concat(mla_delivery_item_confirmed_1.sparepart_id,'+++',max(mla_delivery_item_confirmed_1.last_status_on)) as max_sparepart_id_dn_last_confirmed_key
...
as 	mla_delivery_item_confirmed_1
group by mla_delivery_item_confirmed_1.article_id
) 
as mla_last_confirmed_article_dn
on mla_last_confirmed_article_dn.max_article_id_dn_last_confirmed_key = mla_delivery_item_confirmed_1.article_id_dn_last_confirmed_key

left join /*mla_last_confirmed_spartpart_dn*/
(
/* article, sparepart last confirmed DO */
select
  	max(mla_delivery_item_confirmed_1.last_status_on) as max_last_status_on,
...
as 	mla_delivery_item_confirmed_1
group by mla_delivery_item_confirmed_1.sparepart_id
) 
as mla_last_confirmed_spartpart_dn
on mla_last_confirmed_spartpart_dn.max_sparepart_id_dn_last_confirmed_key = mla_delivery_item_confirmed_1.sparepart_id_dn_last_confirmed_key

WHERE mla_last_confirmed_spartpart_dn.max_sparepart_id_dn_last_confirmed_key  IS NOT NULL OR mla_last_confirmed_article_dn.max_article_id_dn_last_confirmed_key IS NOT NULL