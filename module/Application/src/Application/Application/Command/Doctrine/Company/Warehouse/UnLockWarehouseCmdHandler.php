 ...
 *
 */
class UnLockWarehouseCmdHandler extends AbstractCommandHandler
{
    ...
    public function run(CommandInterface $cmd)
    {
        ...
        try {
            ...
            $rootEntity->unlockWarehouse($companyEntity, $options, $sharedService);
            $this->setOutput($snapshot); // important;

            $m = sprintf("[OK] WH #%s unlocked!", $snapshot->getId());
            $cmd->addSuccess($m);
