 ...
 *        
 */
class IncotermController extends AbstractActionController
{

    protected $incotermService;
     ...
     */
    public function getIncotermService()
    {
     ...
     */
    public function setIncotermService(\Application\Service\IncotermService $incotermService)
    {
