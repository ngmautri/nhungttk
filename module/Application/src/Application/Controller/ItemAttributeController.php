...
use Application\Form\ItemAttribute\ItemAttributeForm;
use Application\Form\ItemAttribute\ItemAttributeGroupForm;
 ...
 *
 */
class ItemAttributeController extends EntityCRUDController
{
    ...
    {
        $this->baseUrl = '/application/item-attribute';
    }
    ...
    {
        $form = new ItemAttributeGroupForm("root_form_" . 'ItemAttributeController');
        $form->setAction($form_action);
        $form->setHydrator(new Reflection());
        $form->setRedirectUrl('/application/item-attribute/list');
    ...
    {
        $form = new ItemAttributeForm("member_form_" . 'ItemAttributeController');
        $form->setAction($form_action);
        $form->setHydrator(new Reflection());
        $form->setFormAction($action);
