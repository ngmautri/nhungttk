<?php
namespace Application\Domain\Company\AccessControl\Factory;

use Application\Application\Event\DefaultParameter;
use Application\Domain\Company\BaseCompany;
use Application\Domain\Company\AccessControl\BaseRole;
use Application\Domain\Company\AccessControl\RoleSnapshot;
...
class RoleFactory
{
    ...
    public static function contructFromDB(RoleSnapshot $snapshot)
    {
    ...
    public static function createFrom(BaseCompany $companyEntity, BaseRole $snapshot, CommandOptions $options, SharedServiceInterface $sharedService)
    {
