...
use Application\Domain\Company\PostingPeriod\AccessControl\RoleDefinition;
...
class RoleSnapshotAssembler
{
    ...
    {
        return GenericObjectAssembler::updateIncludedFieldsFromArray($target, $source, RoleDefinition::$defaultIncludedFields);
    }
