<?php
namespace Application\Domain\Company\AccessControl\Tree;
 ...
 *
 */
class DefaultRoleTree extends AbstractTree
{

    private $role;

    public function __construct(BaseRole $role)
    {
        if (! $role instanceof BaseRole) {
            throw new \InvalidArgumentException("BaseRole required!");
        }
