 ...
 * NmtApplicationUom
 *
 * @ORM\Table(name="nmt_application_uom", uniqueConstraints={@ORM\UniqueConstraint(name="uom_name_UNIQUE", columns={"uom_name"})}, indexes={@ORM\Index(name="nmt_application_uom_FK1_idx", columns={"created_by"})})
 * @ORM\Entity
 */
