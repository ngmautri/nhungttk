 ...
 * NmtProcureChangeLog
 *
 * @ORM\Table(name="nmt_procure_change_log", indexes={@ORM\Index(name="nmt_procure_change_log_FK1_idx", columns={"created_by"}), @ORM\Index(name="nmt_procure_change_log_IDX1", columns={"class_name"}), @ORM\Index(name="nmt_procure_change_log_IDX2", columns={"field_name"}), @ORM\Index(name="nmt_procure_change_log_IDX3", columns={"object_id"}), @ORM\Index(name="nmt_procure_change_log_IDX4", columns={"object_token"}), @ORM\Index(name="nmt_procure_change_log_FK2_idx", columns={"company_id"})})
 * @ORM\Entity
 */
class NmtProcureChangeLog
{
    /**
     * @var integer
     *
