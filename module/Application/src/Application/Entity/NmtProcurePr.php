 ...
 * NmtProcurePr
 *
 * @ORM\Table(name="nmt_procure_pr", indexes={@ORM\Index(name="nmt_procure_pr_KF1_idx", columns={"created_by"}), @ORM\Index(name="nmt_procure_pr_KF3_idx", columns={"department_id"}), @ORM\Index(name="nmt_procure_pr_KF4_idx", columns={"company_id"}), @ORM\Index(name="nmt_procure_pr_KF5_idx", columns={"warehouse_id"}), @ORM\Index(name="nmt_procure_pr_KF2_idx", columns={"lastchange_by"})})
 * @ORM\Entity
 */
class NmtProcurePr
{
