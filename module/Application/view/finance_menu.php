<ul style="font-size: 10.5pt" class="dropdown-menu">
	...
	<li><a href="/finance/v-invoice/add"><i class="fa fa-plus"
			aria-hidden="true"></i>&nbsp;&nbsp;New A/P Invoice</a></li>
	<li><a href="/finance/v-invoice/add"><i class="fa fa-plus"
			aria-hidden="true"></i>&nbsp;&nbsp;New A/P Invoice from Contract/PO</a></li>
	...
	<li class="divider"></li>
	<li><a href="/finance/activity-log/list"><i class="fa fa-caret-right"
