...
<ul style="font-size: 10.5pt" class="dropdown-menu">
	...
	<li><a href="/inventory/item-category/list"><small><i
	...
	<li class="divider"></li>
	<li><a href="/inventory/report/index"><i class="fa fa-book"
			aria-hidden="true"></i>&nbsp;<?php echo $this->translate('Reporting'); ?></a></li>


	<li class="divider"></li>
	<li><a href="/inventory/setting/index"><i class="fa fa-cog"
			aria-hidden="true"></i>&nbsp;<?php echo $this->translate('Setup'); ?></a></li>

	<li class="divider"></li>
	<li><a href="/inventory/activity-log/list"><i class="fa fa-caret-right"
