<ul style="font-size: 10pt" class="dropdown-menu">
	<li><a href="/procurement/pr/cart"> <i class="icon-shopping-cart"> </i>
			Review Cart
	</a></li>
	<li class="divider"></li>
	...
	<li><a href="/procure/pr-row/all"><i class="fa fa-caret-right" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;PR Row list</a></li>
		<li class="divider"></li>
	<li><a href="/procure/quote/add"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;<?php echo $this->translate("New Quotation");?></a></li>
	...
	<li class="divider"></li>
	<li><a href="/procure/return/add"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;<?php echo $this->translate("Goods Return");?></a></li>
