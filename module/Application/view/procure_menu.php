<ul style="font-size: 10pt" class="dropdown-menu">
	...
	<li class="divider"></li>
	<li><a href="/inventory/gr/add"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;New Goods Receipt (GR)</a></li>
	<li><a href="/inventory/gr/list1"><i class="fa fa-caret-right" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;GR list</a></li>
