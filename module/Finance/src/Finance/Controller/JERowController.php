 ...
 *        
 */
class JERowController extends AbstractActionController
{
    ...
    public function listAction()
    {
        ...
        if ($total_records > $resultsPerPage) {
            ...
            $list = $this->doctrineEM->getRepository('Application\Entity\FinJeRow')->findBy($criteria, $sort_criteria, ($paginator->getMaxInPage() - $paginator->getMinInPage()) + 1, $paginator->getMinInPage() - 1);
        }
