...
class AccountService extends AbstractService
{
    ...
    /**
     *
     * @param \Application\Entity\FinAccount $entity
     * @param array $data
     * @/param boolean $isPosting
     */
    public function validateHeader(\Application\Entity\FinAccount $entity, $data)
    {
        $errors = array();

        if (! $entity instanceof \Application\Entity\FinAccount) {
            $errors[] = $this->controllerPlugin->translate('Account is not found!');
        }
    ...
    public function saveHeader($entity, $u, $isNew = FALSE)
    {
        ...
        if (! $entity instanceof \Application\Entity\FinAccount) {
            $m = $this->controllerPlugin->translate("Invalid Argument! Account Object not found!");
            throw new \Exception($m);
        }
