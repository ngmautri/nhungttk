<div style="font-size: 9pt; margin: 5pt 2pt 5pt 5pt">
	<a style="font-size: 9pt; margin: 10pt 2pt 20pt 20pt"
		class="btn btn-default btn-sm" href="/finance/v-invoice/list"> <small><i
			class="fa fa-chevron-left" aria-hidden="true"></i></small>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->translate("AP List");?></a>
	...
	<?php else:?>
		<a style="color: gray" class="list-group-item" href="#">1. <?php echo $this->translate('A/P Invoice Header'); ?></a>
	<?php endif;?>
...
<?php if ($current_step=="STEP1") :?>
<div
		style="padding: 1px; font-size: 9.5pt; margin: 5pt 2pt 5pt 5pt; color: graytext;">
		<i class="fa fa-info-circle" aria-hidden="true"></i>&nbsp;<?php echo $this->translate("Goods receipt with invoice");?>.&nbsp;<?php echo $this->translate("Without invoice, please click ");?> <a
			style="color: navy" class="" target="_blank"
