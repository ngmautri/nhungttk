<div style="font-size: 9pt; margin: 5pt 2pt 5pt 5pt">
	...
	<small><i class="fa fa-chevron-left" aria-hidden="true"></i></small>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->translate("AP List");?></a>
...
<div style="padding: 1px; font-size: 9.5pt; margin: 5pt 2pt 5pt 5pt; color:graytext;">
	<i class="fa fa-info-circle" aria-hidden="true"></i>&nbsp;<?php echo $this->translate("Goods receipt with invoice");?>.&nbsp;<?php echo $this->translate("Without invoice, please click ");?> <a style="color: navy" class="" target="_blank"
