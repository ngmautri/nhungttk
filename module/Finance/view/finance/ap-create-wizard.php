<div class="list-group">
	...
	<?php else:?>
		<a style="color: gray" class="list-group-item"
		href="#">2. <?php echo $this->translate('A/P Invoice Line'); ?></a>
	<?php endif;?>
		<?php if ($current_step=="STEP2") :?>
		<a style="color: gray" class="list-group-item" 
		href="<?php echo $this->baseUrl ?>/finance/v-invoice/add1?token=<?php echo (!$target == null)? $target->getToken():"";?>&entity_id=<?php echo (!$target == null)? $target->getId():"";?>">3. <?php echo $this->translate('Finish'); ?>&nbsp;&nbsp;&nbsp;</a>
	<?php else:?>
		<a style="color: gray" class="list-group-item"
