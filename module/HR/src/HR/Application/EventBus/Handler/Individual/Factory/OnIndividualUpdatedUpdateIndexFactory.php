<?php
namespace HR\Application\EventBus\Handler\Individual\Factory;
 ...
 *        
 */
class OnIndividualUpdatedUpdateIndexFactory implements FactoryInterface
{
    ...
    public function createService(ServiceLocatorInterface $serviceLocator)
    {
        ...
        $service = new OnIndividualUpdatedUpdateIndex($doctrineEM, $eventBusService);
