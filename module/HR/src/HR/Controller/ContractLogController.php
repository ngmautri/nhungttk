...
class ContractLogController extends AbstractActionController
{
    ...
    public function list1Action()
    {
        ...
        if ($total_records > $resultsPerPage) {
            ...
            $list = $this->doctrineEM->getRepository('Application\Entity\NmtHrContractLog')->findBy($criteria, $sort_criteria, ($paginator->getMaxInPage() - $paginator->getMinInPage()) + 1, $paginator->getMinInPage() - 1);
        }
