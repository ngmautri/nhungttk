...
class EmployeeAttachmentController extends AbstractActionController {
	...
	public function updateTokenAction() {
		...
		$list = $this->doctrineEM->getRepository ( 'Application\Entity\NMTApplicationAttachment' )->findBy ( $criteria, $sort_criteria );
		...
		if ($total_records > $resultsPerPage) {
			$paginator = new Paginator ( $total_records, $page, $resultsPerPage );
			$list = $this->doctrineEM->getRepository ( 'Application\Entity\NMTApplicationAttachment' )->findBy ( $criteria, $sort_criteria, ($paginator->maxInPage - $paginator->minInPage) + 1, $paginator->minInPage - 1 );
		}
