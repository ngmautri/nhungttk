...
class WarehouseLoggingListener implements ListenerAggregateInterface
{
    ...
    {
        $this->listeners[] = $events->attach(self::WH_CREATED_LOG, array(
            $this,
            'onWarehouseCreatedLog'
        ), 200);

        $this->listeners[] = $events->attach(self::WH_UPDATED_LOG, array(
            $this,
            'onWarehouseUpdatedLog'
        ), 200);
    }
     ...
     */
    public function onWarehouseCreatedLog(EventInterface $e)
    {
