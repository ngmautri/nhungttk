 ...
 *        
 */
class OnWhTransferLocationPostedCreateTrxFactory implements FactoryInterface
{
    ...
    public function createService(ServiceLocatorInterface $serviceLocator)
    {
        ...
        $service = new OnWhTransferLocationPostedCreateTrx($doctrineEM, $eventBusService);
