<?php
namespace Inventory\Application\Reporting\Item\Export\Spreadsheet;
 ...
 *        
 */
class InOutOnhandOpenOfficeBuilder extends AbstractBuilder
{
    ...
    public function buildFooter($params = null)
    {
        ...
        $filename_tmp = sprintf("Item_In_Out_Onhand_Report_%s.ods", $docNumber);
