...
class CompositeItem extends GenericItem
{
    ...
    private $memberCollectionRef;

    public function addMemberFrom(CompositeSnapshot $snapshot, CommandOptions $options, \Application\Domain\Service\Contracts\SharedServiceInterface $sharedService)
    {
    ...
    /**
     * @param mixed $memberCollection
     */
    public function setMemberCollection($memberCollection)
    {
     ...
     * @return mixed
     */
    public function getMemberCollectionRef()
    {
        return $this->memberCollectionRef;
    }

    /**
     * @param mixed $memberCollectionRef
     */
    public function setMemberCollectionRef($memberCollectionRef)
    {
        $this->memberCollectionRef = $memberCollectionRef;
    }
