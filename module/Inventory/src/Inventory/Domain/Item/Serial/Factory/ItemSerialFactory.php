<?php
namespace Inventory\Domain\Item\Serial\Factory;
 ...
 *
 */
class ItemSerialFactory
{

    public static function contructFromDB(SerialSnapshot $snapshot)
    {
        if (! $snapshot instanceof SerialSnapshot) {
            throw new InvalidArgumentException("SerialSnapshot not found!");
        }

        $instance = new GenericSerial();
