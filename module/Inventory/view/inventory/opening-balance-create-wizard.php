...
if ($current_step == "STEP1") :
    ...
    echo $this->translate('Opening Balance Header');
...
if ($current_step == "STEP2") :
    ...
    echo $this->translate('Opening Balance Line');
    ?>&nbsp;&nbsp;&nbsp;<i class="fa fa-chevron-right" aria-hidden="true"></i>
      </a>
	<?php
    ...
    echo $this->baseUrl?>/inventory/item-opening-balance/addRow?target_token=<?php
