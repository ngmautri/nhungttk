...
class UpdateRowCmdHandler extends AbstractCommandHandler
{
    ...
    public function run(CommandInterface $cmd)
    {
        ...
        try {
            ...
            APRowSnapshotAssembler::updateDefaultIncludedFieldsFromArray($newSnapshot, $cmd->getData());
            ...
            $m = sprintf("AP row #%s updated. Memory used #%s", $rootEntity->getId(), memory_get_usage());
            $cmd->addSuccess($m);
        } catch (\Exception $e) {
