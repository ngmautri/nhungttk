...
use Procure\Application\Command\PO\Options\PoUpdateHeaderAndPostOptions;
 ...
 *        
 */
class UpdateHeaderAndPostCmdHandler extends AbstractDoctrineCmdHandler
{
    ...
    public function run(CommandInterface $cmd)
    {
        ...
        if (! $options instanceof PoUpdateHeaderAndPostOptions) {
