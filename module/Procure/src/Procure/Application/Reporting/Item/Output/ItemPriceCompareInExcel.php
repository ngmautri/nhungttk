 ...
 *        
 */
class ItemPriceCompareInExcel extends ItemPriceCompareOutputStrategy
{
    ...
    public function createOutput($result)
    {
        ...
        foreach ($result as $r) {
            ...
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('B' . $l, $a->getPr()->getPrName());
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('C' . $l, $a->getPr()->getSubmittedOn());
