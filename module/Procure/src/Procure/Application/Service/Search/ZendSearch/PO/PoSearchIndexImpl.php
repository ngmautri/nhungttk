...
class PoSearchIndexImpl extends AbstractService implements PoSearchIndexInterface
{
    ...
    private function _createIndexFromRowSnapshot(\ZendSearch\Lucene\SearchIndexInterface $index, BaseRowSnapshot $row)
    {
        ...
        $doc->addField(Field::text('companyId', $row->getCompanyId()));
        $doc->addField(Field::text('companyToken', $row->getCompanyToken()));
        $doc->addField(Field::text('companyName', $row->getCompanyName()));
        $doc->addField(Field::text('vendorId', $row->getVendorId()));
        $doc->addField(Field::text('vendorToken', $row->getVendorToken()));
        ...
        $doc->addField(Field::text('docSysNumber', $row->getDocSysNumber()));
        ...
        $doc->addField(Field::text('docToken', $row->getDocToken()));
        $doc->addField(Field::text('docId', $row->getDocId()));
        ...
        $doc->addField(Field::text('itemToken', $row->getItemToken()));
        ...
        $doc->addField(Field::text('itemSKU', $row->getItemSKU()));
        $doc->addField(Field::text('itemSKU1', $row->getItemSKU1()));
        $doc->addField(Field::text('itemSKU2', $row->getItemSKU2()));
        $doc->addField(Field::text('itemUUID', $row->getItemUUID()));
        $doc->addField(Field::text('itemSysNumber', $row->getItemSysNumber()));
        ...
        $doc->addField(Field::text('itemVersion', $row->getItemVersion()));
        $doc->addField(Field::text('isInventoryItem', $row->getIsInventoryItem()));
        $doc->addField(Field::text('isFixedAsset', $row->getIsFixedAsset()));
        ...
        $doc->addField(Field::text('itemAssetLabel', $row->getItemAssetLabel()));
        $doc->addField(Field::text('itemAssetLabel1', $row->getItemAssetLabel1()));
        $doc->addField(Field::text('itemInventoryGL', $row->getItemInventoryGL()));
        $doc->addField(Field::text('itemCogsGL', $row->getItemCogsGL()));
        $doc->addField(Field::text('itemCostCenter', $row->getItemCostCenter()));
        ...
        $doc->addField(Field::text('rowNumber', $row->getRowNumber()));
        $doc->addField(Field::text('token', $row->getToken()));
        $doc->addField(Field::text('quantity', $row->getQuantity()));
        $doc->addField(Field::text('unitPrice', $row->getUnitPrice()));
        $doc->addField(Field::text('netAmount', $row->getNetAmount()));
        $doc->addField(Field::text('unit', $row->getUnit()));
        $doc->addField(Field::text('itemUnit', $row->getItemUnit()));
        ...
        $doc->addField(Field::text('rowIdentifer', $row->getRowIdentifer()));
        ...
        $doc->addField(Field::text('docStatus', $row->getDocStatus()));
        ...
        $doc->addField(Field::text('docQuantity', $row->getDocQuantity()));
        $doc->addField(Field::text('docUnit', $row->getDocUnit()));
        $doc->addField(Field::text('docUnitPrice', $row->getDocUnitPrice()));
        $doc->addField(Field::text('convertedPurchaseUnitPrice', $row->getConvertedPurchaseUnitPrice()));
        $doc->addField(Field::text('docType', $row->getDocType()));
        $doc->addField(Field::text('descriptionText', $row->getDescriptionText()));
        ...
        $doc->addField(Field::text('item', $row->getItem()));
        ...
        $doc->addField(Field::text('glAccount', $row->getGlAccount()));
        $doc->addField(Field::text('costCenter', $row->getCostCenter()));
