 ...
 *        
 */
class ApSearchController extends AbstractActionController
{

    protected $doctrineEM;

    protected $apSearchService;
    ...
    public function autocompleteAction()
    {
        ...
        if ($q !== "") {
            $results = $this->apSearchService->search($q, $vendor_id);
    ...
    public function doAction()
    {
        ...
        if ($q !== "") {
            $results = $this->apSearchService->search($q);
        } else {
            $results = [
                "message" => "",
                "hits" => null
    ...
    {
        $result = $this->apSearchService->createIndex();
        return new ViewModel(array(
            'result' => $result
        ));
    }
    ...
    /**
     * 
     * @return \Procure\Service\ApSearchService
     */
    public function getApSearchService()
    {
        return $this->apSearchService;
    }

    /**
     *  
     * @param \Procure\Service\ApSearchService $apSearchService
     */
    public function setApSearchService(\Procure\Service\ApSearchService $apSearchService)
    {
        $this->apSearchService = $apSearchService;
    }
