 ...
 *        
 */
class PrSearchController extends AbstractGenericController
{
    ...
    /**
     *
     * @return \Procure\Domain\Service\Search\PrSearchQueryInterface
     */
    ...
    /**
     *
     * @param PrSearchQueryInterface $queryService
     */
    public function setQueryService(PrSearchQueryInterface $queryService)
    {
    ...
    public function doAction()
    {
        ...
        $viewTemplete = "procure/pr-search/search-result";
     ...
     * @return \Procure\Controller\PrSearchController
     */
