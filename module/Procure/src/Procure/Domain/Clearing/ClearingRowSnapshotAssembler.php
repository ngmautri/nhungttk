...
use Procure\Domain\Clearing\Definition\ClearingRowDefinition;
 ...
 *        
 */
class ClearingRowSnapshotAssembler
{
    ...
    {
        return GenericObjectAssembler::updateIncludedFieldsFromArray($target, $source, ClearingRowDefinition::$defaultIncludedFields);
    }

    public static function updateDefaultExcludedFieldsFromArray(AbstractDTO $target, $source)
    {
        return GenericObjectAssembler::updateIncludedFieldsFromArray($target, $source, ClearingRowDefinition::$defaultExcludedFields);
    }
    ...
    {
        return GenericObjectAssembler::updateIncludedFieldsFrom($target, $source, ClearingRowDefinition::$defaultIncludedFields);
    }

    public static function updateDefaultExcludedFieldsFrom($target, AbstractDTO $source)
    {
        return GenericObjectAssembler::updateExcludedFieldsFrom($target, $source, ClearingRowDefinition::$defaultExcludedFields);
    }
    ...
    {
        if ($properties == null) {
            $properties = ClearingRowDefinition::$defaultExcludedFields;
        }
    ...
    {
        if ($properties == null) {
            $properties = ClearingRowDefinition::$defaultIncludedFields;
        }
