...
class PoMapper
{
    ...
    public static function createRowSnapshot(EntityManager $doctrineEM, NmtProcurePoRow $entity, $snapshot = null)
    {
        ...
        $snapshot->apSysNumber = "sdfdsf";

        // $snapshot->invoice= $entity->getInvoice();
        if ($entity->getInvoice() != null) {
            $snapshot->invoice = $entity->getInvoice()->getId();
            $snapshot->apDocId = $entity->getInvoice()->getId();
            $snapshot->apDocToken = $entity->getInvoice()->getToken();
            $snapshot->apSysNumber = $entity->getInvoice()->getSysNumber();
        }
