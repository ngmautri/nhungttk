 ...
 *        
 */
class GrReportSqlFilter implements SqlFilterInterface
{
    ...
    {
        return \sprintf("GrReportSqlFilter_%s_%s_%s_%s_%s", $this->isActive, $this->docYear, $this->docMonth, $this->docStatus, $this->balance);
    }
