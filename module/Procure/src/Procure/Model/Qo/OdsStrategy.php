 ...
 *
 */
class OdsStrategy extends DownloadStrategyAbstract
{
    /**
     * 
     * {@inheritDoc}
    ...
    public function doDownload($entity)
    {
        ...
        foreach ($rows as $r) {
            ...
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('D' . $l, $a->getDocUnitPrice());
            
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('E' . $l, $a->getDocUnit());
            
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('F' . $l, $a->getDocUnitPrice());
        ...
        header('Content-Disposition: attachment;filename="' . $entity->getSysNumber() . '.ods"');
