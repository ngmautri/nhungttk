<div style="font-size: 9pt; margin: 5pt 2pt 5pt 5pt">
    <a style="font-size: 9pt; margin: 10pt 2pt 20pt 20pt" class="btn btn-default btn-sm" href="/finance/v-invoice/list"> <small><i class="fa fa-chevron-left" aria-hidden="true"></i></small>&nbsp;&nbsp;&nbsp;&nbsp;<?php
...
echo $this->translate("Without invoice, please click ");
 ?> <a
            style="color: navy" class="" target="_blank" href="<?php

echo $this->baseUrl?>/procure/gr/add"><?php
