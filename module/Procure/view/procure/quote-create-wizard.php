...
if ($current_step == "STEP1") :
    ...
    echo $this->translate('Quotation Header');
...
if ($current_step == "STEP2") :
    ...
    echo $this->translate('Quotation Line');
    ?>&nbsp;&nbsp;&nbsp;<i class="fa fa-chevron-right" aria-hidden="true"></i>
      </a>
	<?php
    ...
    ?>
		<a style="color: gray" class="list-group-item" href="#">2. <?php
...
if ($current_step == "STEP2") :
    ...
    echo $this->baseUrl?>/procure/quote/show?token=<?php
