...
use Procurement\Controller\CashController;

/*
 * @author nmt
 *
 */
class CashControllerFactory implements FactoryInterface {
	...
	public function createService(ServiceLocatorInterface $serviceLocator) {
		...
		// Delivery Cart table
		$tbl =  $sm->get ('Procurement\Model\POItemTable' );
		$controller->setPoItemTable($tbl);
