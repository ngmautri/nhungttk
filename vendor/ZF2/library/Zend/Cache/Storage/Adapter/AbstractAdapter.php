...
abstract class AbstractAdapter implements StorageInterface, EventsCapableInterface {
	 ...
	 * @throws Exception\ExceptionInterface @triggers getMetadatas.pre(PreEvent)
	 ...
	 * @throws Exception\ExceptionInterface @triggers incrementItem.pre(PreEvent)
	 ...
	 * @throws Exception\ExceptionInterface @triggers incrementItems.pre(PreEvent)
	 ...
	 * @param int $value        	
	 * @return int|bool The new value on success, false on failure
	 * @throws Exception\ExceptionInterface @triggers decrementItem.pre(PreEvent)
	 ...
	 *
	 * @return Capabilities @triggers getCapabilities.pre(PreEvent)
	...
	protected function normalizeKey(& $key) {
		...
		if ($key === '') {
			...
			throw new Exception\InvalidArgumentException ( "The key '{$key}' doesn't match agains pattern '{$p}'" );
		}
	}
