...
class Redis extends AbstractAdapter implements FlushableInterface, TotalSpaceCapableInterface {
	 ...
	 *
	 * @param
	 *        	string &$normalizedKey Key where to store data
	 * @param
	 *        	bool &$success If the operation was successfull
	 * @param
	 *        	mixed &$casToken Token
	 ...
	 *
	 * @param
	 *        	array &$normalizedKeys Array of keys to be obtained
	 *        	
	 ...
	 *
	 * @param
	 *        	string &$normalizedKey Normalized key which will be checked
	 *        	
	 * @return bool
	 * @throws Exception\RuntimeException
	 */
	 ...
	 *
	 * @param
	 *        	string &$normalizedKey Key in Redis under which value will be saved
	 * @param
	 *        	mixed &$value Value to store under cache key
	 *        	
	 * @return bool
	 * @throws Exception\RuntimeException
	 */
	 ...
	 *
	 * @param
	 *        	array &$normalizedKeyValuePairs An array of normalized key/value pairs
	 *        	
	 ...
	 *
	 * @param
	 *        	string &$normalizedKey Key which will be removed
	 *        	
	 * @return bool
	 * @throws Exception\RuntimeException
	 */
	...
	protected function internalGetCapabilities() {
		if ($this->capabilities === null) {
			...
			// get/set methods
			$this->capabilities = new Capabilities ( $this, $this->capabilityMarker, array (
