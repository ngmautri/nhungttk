...
class XCache extends AbstractAdapter implements AvailableSpaceCapableInterface, ClearByNamespaceInterface, ClearByPrefixInterface, FlushableInterface, IterableInterface, TotalSpaceCapableInterface {
	...
	protected function internalSetItem(& $normalizedKey, & $value) {
		...
		if (! xcache_set ( $internalKey, $value, $ttl )) {
			...
			throw new Exception\RuntimeException ( "xcache_set('{$internalKey}', <{$type}>, {$ttl}) failed" );
		}
