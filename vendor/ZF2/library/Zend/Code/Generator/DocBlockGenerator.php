...
class DocBlockGenerator extends AbstractGenerator {
	...
	public function setTag($tag) {
		if (is_array ( $tag )) {
			...
			throw new Exception\InvalidArgumentException ( sprintf ( '%s expects either an array of method options or an instance of %s\DocBlock\Tag', __METHOD__, __NAMESPACE__ ) );
		}
