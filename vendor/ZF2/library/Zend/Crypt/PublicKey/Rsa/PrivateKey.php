...
class PrivateKey extends AbstractKey {
	...
	public static function fromFile($pemFile, $passPhrase = null) {
		if (! is_readable ( $pemFile )) {
			throw new Exception\InvalidArgumentException ( "PEM file '{$pemFile}' is not readable" );
		}
	...
	public function __construct($pemString, $passPhrase = null) {
		...
		if (false === $result) {
			throw new Exception\RuntimeException ( 'Unable to load private key; openssl ' . openssl_error_string () );
		}
