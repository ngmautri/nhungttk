...
class Statement implements StatementInterface, Profiler\ProfilerAwareInterface {
	...
	public function prepare($sql = null) {
		...
		if (! $this->resource instanceof \mysqli_stmt) {
			throw new Exception\InvalidQueryException ( 'Statement couldn\'t be produced with sql: ' . $sql, null, new Exception\ErrorException ( $this->mysqli->error, $this->mysqli->errno ) );
		}
