...
abstract class AbstractTableGateway implements TableGatewayInterface {
	...
	protected function executeSelect(Select $select) {
		...
		$this->featureSet->apply ( 'preSelect', array (
				$select 
		) );
	...
	protected function executeInsert(Insert $insert) {
		...
		$this->featureSet->apply ( 'preInsert', array (
				$insert 
		) );
		...
		$this->featureSet->apply ( 'postInsert', array (
				$statement,
				$result 
		) );
	...
	protected function executeUpdate(Update $update) {
		...
		$this->featureSet->apply ( 'preUpdate', array (
				$update 
		) );
		...
		$this->featureSet->apply ( 'postUpdate', array (
				$statement,
				$result 
		) );
	...
	protected function executeDelete(Delete $delete) {
		...
		// pre delete update
		$this->featureSet->apply ( 'preDelete', array (
				$delete 
		) );
		...
		$this->featureSet->apply ( 'postDelete', array (
				$statement,
				$result 
		) );
