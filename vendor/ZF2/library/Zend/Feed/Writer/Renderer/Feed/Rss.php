...
class Rss extends Renderer\AbstractRenderer implements Renderer\RendererInterface {
	...
	protected function _setDateModified(DOMDocument $dom, DOMElement $root) {
		...
		$text = $dom->createTextNode ( $this->getDataContainer ()->getDateModified ()->format ( DateTime::RSS ) );
	...
	protected function _setGenerator(DOMDocument $dom, DOMElement $root) {
		if (! $this->getDataContainer ()->getGenerator ()) {
			$this->getDataContainer ()->setGenerator ( 'Zend_Feed_Writer', Version::VERSION, 'http://framework.zend.com' );
		}
	...
	protected function _setLastBuildDate(DOMDocument $dom, DOMElement $root) {
		...
		$text = $dom->createTextNode ( $this->getDataContainer ()->getLastBuildDate ()->format ( DateTime::RSS ) );
