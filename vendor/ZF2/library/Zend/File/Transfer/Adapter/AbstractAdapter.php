...
abstract class AbstractAdapter implements TranslatorAwareInterface {
	 ...
	 *
	 * @param string|Validator\ValidatorInterface $validator
	...
	public function isValid($files = null) {
		...
		foreach ( $check as $content ) {
			if (array_key_exists ( 'validators', $content ) && in_array ( 'Zend\Validator\File\Count', $content ['validators'] )) {
	 ...
	 *
	 * @param string|Filter\FilterInterface $filter
