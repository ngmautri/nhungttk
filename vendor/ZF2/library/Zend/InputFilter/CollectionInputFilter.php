...
class CollectionInputFilter extends InputFilter {
	...
	public function setInputFilter($inputFilter) {
		...
		if (! $inputFilter instanceof BaseInputFilter) {
			throw new Exception\RuntimeException ( sprintf ( '%s expects an instance of %s; received "%s"', __METHOD__, 'Zend\InputFilter\BaseInputFilter', (is_object ( $inputFilter ) ? get_class ( $inputFilter ) : gettype ( $inputFilter )) ) );
		}
