...
class Validator implements FilterInterface {
	...
	public function __construct($validator) {
		...
		if (! $validator instanceof ZendValidator) {
			throw new Exception\InvalidArgumentException ( sprintf ( 'Parameter of type %s is invalid; must implements Zend\Validator\ValidatorInterface', (is_object ( $validator ) ? get_class ( $validator ) : gettype ( $validator )) ) );
		}
