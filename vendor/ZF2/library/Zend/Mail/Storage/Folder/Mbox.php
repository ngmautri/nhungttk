...
class Mbox extends Storage\Mbox implements FolderInterface {
	 ...
	 * @param \Zend\Mail\Storage\Folder|null $parentFolder
	 *        	used for recursion
	...
	public function selectFolder($globalName) {
		...
		try {
			...
			$this->_buildFolderTree ( $this->rootdir );
			throw new Exception\RuntimeException ( 'seems like the mbox file has vanished, I\'ve rebuild the ' . 'folder tree, search for an other folder and try again', 0, $e );
		}
	}
