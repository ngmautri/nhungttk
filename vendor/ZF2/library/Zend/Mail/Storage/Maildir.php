...
class Maildir extends AbstractStorage {
	...
	public function getMessage($id) {
		...
		if (strtolower ( $this->messageClass ) == '\zend\mail\storage\message\file' || is_subclass_of ( $this->messageClass, '\Zend\Mail\Storage\Message\File' )) {
