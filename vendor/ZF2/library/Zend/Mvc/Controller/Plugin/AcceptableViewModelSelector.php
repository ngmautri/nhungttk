...
class AcceptableViewModelSelector extends AbstractPlugin {
	 ...
	 * @param AbstractFieldValuePart|null $resultReference
	 ...
	 */
	public function __invoke(array $matchAgainst = null, $returnDefault = true, & $resultReference = null) {
	 ...
	 * @return ModelInterface|null
	 */
	public function getViewModel(array $matchAgainst = null, $returnDefault = true, & $resultReference = null) {
	 ...
	 */
	public function getViewModelName(array $matchAgainst = null, $returnDefault = true, & $resultReference = null) {
	 ...
	 * 
	 * @param string $defaultViewModelName
	...
	protected function getEvent() {
		...
		if (! $controller instanceof InjectApplicationEventInterface) {
			throw new DomainException ( 'A controller that implements InjectApplicationEventInterface ' . 'is required to use ' . __CLASS__ );
		}
