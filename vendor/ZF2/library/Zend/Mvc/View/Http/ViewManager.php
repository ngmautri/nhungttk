...
class ViewManager extends AbstractListenerAggregate {
	...
	public function onBootstrap($event) {
		...
		$this->config = isset ( $config ['view_manager'] ) && (is_array ( $config ['view_manager'] ) || $config ['view_manager'] instanceof ArrayAccess) ? $config ['view_manager'] : array ();
	...
	public function getRendererStrategy() {
		...
		$this->rendererStrategy = new PhpRendererStrategy ( $this->getRenderer () );
