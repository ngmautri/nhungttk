...
abstract class AbstractPage extends AbstractContainer {
	...
	public static function factory($options) {
		...
		if (! is_array ( $options )) {
			throw new Exception\InvalidArgumentException ( 'Invalid argument: $options must be an array or Traversable' );
		}
		...
		if (isset ( $options ['type'] )) {
			...
			if (is_string ( $type ) && ! empty ( $type )) {
				...
				if (! $page instanceof self) {
					throw new Exception\InvalidArgumentException ( sprintf ( 'Invalid argument: Detected type "%s", which ' . 'is not an instance of Zend\Navigation\Page', $type ) );
				}
				return $page;
			}
		}
		...
		if ($hasMvc) {
			...
			throw new Exception\InvalidArgumentException ( 'Invalid argument: Unable to determine class to instantiate' );
		}
	}
	...
	public function setLabel($label) {
		if (null !== $label && ! is_string ( $label )) {
			throw new Exception\InvalidArgumentException ( 'Invalid argument: $label must be a string or null' );
		}
	...
	public function setFragment($fragment) {
		if (null !== $fragment && ! is_string ( $fragment )) {
			throw new Exception\InvalidArgumentException ( 'Invalid argument: $fragment must be a string or null' );
		}
	...
	public function setId($id = null) {
		if (null !== $id && ! is_string ( $id ) && ! is_numeric ( $id )) {
			throw new Exception\InvalidArgumentException ( 'Invalid argument: $id must be a string, number or null' );
		}
	...
	public function setClass($class = null) {
		if (null !== $class && ! is_string ( $class )) {
			throw new Exception\InvalidArgumentException ( 'Invalid argument: $class must be a string or null' );
		}
	...
	public function setTitle($title = null) {
		if (null !== $title && ! is_string ( $title )) {
			throw new Exception\InvalidArgumentException ( 'Invalid argument: $title must be a non-empty string' );
		}
	...
	public function setTarget($target = null) {
		if (null !== $target && ! is_string ( $target )) {
			throw new Exception\InvalidArgumentException ( 'Invalid argument: $target must be a string or null' );
		}
	 ...
	 *
	 * @param array|Traversable $relations
	...
	public function setRel($relations = null) {
		...
		if (null !== $relations) {
			...
			if (! is_array ( $relations )) {
				throw new Exception\InvalidArgumentException ( 'Invalid argument: $relations must be an ' . 'array or an instance of Traversable' );
			}
	...
	public function getRel($relation = null) {
		if (null !== $relation) {
			return isset ( $this->rel [$relation] ) ? $this->rel [$relation] : null;
		}
	...
	public function getRev($relation = null) {
		if (null !== $relation) {
			return isset ( $this->rev [$relation] ) ? $this->rev [$relation] : null;
		}
	...
	public function setOrder($order = null) {
		...
		if (null !== $order && ! is_int ( $order )) {
			throw new Exception\InvalidArgumentException ( 'Invalid argument: $order must be an integer or null, ' . 'or a string that casts to an integer' );
		}
	 ...
	 *        	[optional] resource to associate
	...
	public function setResource($resource = null) {
		if (null === $resource || is_string ( $resource ) || $resource instanceof AclResource) {
			$this->resource = $resource;
		} else {
			throw new Exception\InvalidArgumentException ( 'Invalid argument: $resource must be null, a string, ' . 'or an instance of Zend\Permissions\Acl\Resource\ResourceInterface' );
		}
	 ...
	 *        	[optional] permission to associate
	 *        	with this page. Default is null, which
	 *        	sets no permission.
	 *        	
	 * @return AbstractPage fluent interface, returns self
	...
	public function set($property, $value) {
		if (! is_string ( $property ) || empty ( $property )) {
			throw new Exception\InvalidArgumentException ( 'Invalid argument: $property must be a non-empty string' );
		}
	...
	public function __unset($name) {
		...
		if (method_exists ( $this, $method )) {
			throw new Exception\InvalidArgumentException ( sprintf ( 'Unsetting native property "%s" is not allowed', $name ) );
		}
