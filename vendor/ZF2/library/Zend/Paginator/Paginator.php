...
class Paginator implements Countable, IteratorAggregate {
	...
	public function __construct($adapter) {
		if ($adapter instanceof AdapterInterface) {
			...
			throw new Exception\InvalidArgumentException ( 'Zend\Paginator only accepts instances of the type ' . 'Zend\Paginator\Adapter\AdapterInterface or Zend\Paginator\AdapterAggregateInterface.' );
		}
	...
	public function getItemsByPage($pageNumber) {
		...
		if ($this->cacheEnabled ()) {
			...
			static::$cache->setTags ( $cacheId, array (
	...
	protected function _loadScrollingStyle($scrollingStyle = null) {
		...
		switch (strtolower ( gettype ( $scrollingStyle ) )) {
			...
			default :
				throw new Exception\InvalidArgumentException ( 'Scrolling style must be a class ' . 'name or object implementing Zend\Paginator\ScrollingStyle\ScrollingStyleInterface' );
		}
	}
}
