...
abstract class AbstractContainer extends ArrayObject {
	...
	protected function setManager(Manager $manager = null) {
		if (null === $manager) {
			...
			if (! $manager instanceof Manager) {
				throw new Exception\InvalidArgumentException ( 'Manager provided is invalid; must implement ManagerInterface' );
			}
		}
	...
	public function setExpirationSeconds($ttl, $vars = null) {
		...
		$storage->setMetadata ( $this->getName (), $data );
