...
class Server implements ZendServerServer {
	 ...
	 *        	Class name or object instance which executes
	...
	public function setClass($class, $namespace = '', $argv = null) {
		...
		if (! is_string ( $class )) {
			throw new Exception\InvalidArgumentException ( sprintf ( 'Invalid class argument (%s)', gettype ( $class ) ) );
		}
		
		if (! class_exists ( $class )) {
			throw new Exception\InvalidArgumentException ( sprintf ( 'Class "%s" does not exist', $class ) );
		}
	...
	public function setObject($object) {
		if (! is_object ( $object )) {
			throw new Exception\InvalidArgumentException ( sprintf ( 'Invalid object argument (%s)', gettype ( $object ) ) );
		}
	...
	public function registerFaultException($class) {
		if (is_array ( $class )) {
			...
			throw new Exception\InvalidArgumentException ( 'Argument for Zend\Soap\Server::registerFaultException should be string or array of strings with valid exception names' );
		}
