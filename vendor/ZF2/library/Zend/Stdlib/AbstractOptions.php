...
abstract class AbstractOptions implements ParameterObjectInterface {
	...
	public function __set($key, $value) {
		...
		if ($this->__strictMode__ && ! method_exists ( $this, $setter )) {
			throw new Exception\BadMethodCallException ( 'The option "' . $key . '" does not ' . 'have a matching ' . $setter . ' setter method ' . 'which must be defined' );
	...
	public function __get($key) {
		...
		if (! method_exists ( $this, $getter )) {
			throw new Exception\BadMethodCallException ( 'The option "' . $key . '" does not ' . 'have a matching ' . $getter . ' getter method ' . 'which must be defined' );
		}
