...
class Iban extends AbstractValidator {
	...
	/**
	 * Optionally allow IBAN codes from non-SEPA countries.
	 * Defaults to true
	 *
	 * @var bool
	 */
	...
	public function setCountryCode($countryCode = null) {
		if ($countryCode !== null) {
			...
			if (! isset ( static::$ibanRegex [$countryCode] )) {
				throw new Exception\InvalidArgumentException ( "Country code '{$countryCode}' invalid by ISO 3166-1 or not supported" );
			}
		}
