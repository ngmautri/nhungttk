 ...
 */
class HeadTitle extends Placeholder\Container\AbstractStandalone implements TranslatorAwareInterface {
	/**
	...
	public function setDefaultAttachOrder($setType) {
		if (! in_array ( $setType, array (
			...
			throw new Exception\DomainException ( "You must use a valid attach order: 'PREPEND', 'APPEND' or 'SET'" );
		}
