...
class Menu extends AbstractHelper {
	 ...
	 *        	Whether or not page class applied to <li> element
	 * @return string
	 */
	protected function renderDeepestMenu(AbstractContainer $container, $ulClass, $indent, $minDepth, $maxDepth, $escapeLabels, $addClassToListItem) {
	...
	public function renderMenu($container = null, array $options = array()) {
		...
		if ($options ['onlyActiveBranch'] && ! $options ['renderParents']) {
			$html = $this->renderDeepestMenu ( $container, $options ['ulClass'], $options ['indent'], $options ['minDepth'], $options ['maxDepth'], $options ['escapeLabels'], $options ['addClassToListItem'] );
		} else {
			$html = $this->renderNormalMenu ( $container, $options ['ulClass'], $options ['indent'], $options ['minDepth'], $options ['maxDepth'], $options ['onlyActiveBranch'], $options ['escapeLabels'], $options ['addClassToListItem'] );
		}
	 ...
	 * @return string
	 */
	protected function renderNormalMenu(AbstractContainer $container, $ulClass, $indent, $minDepth, $maxDepth, $onlyActive, $escapeLabels, $addClassToListItem) {
		$html = '';
	 ...
	 *
	 * @param AbstractContainer $container
	 *        	[optional] container to pass to view
	 *        	script. Default is to use the container
	 *        	registered in the helper.
	 * @param string|array $partial
	 *        	[optional] partial view script to use.
	 ...
	 * @return string
	 */
	public function renderSubMenu(AbstractContainer $container = null, $ulClass = null, $indent = null) {
	 ...
	 *
	 * @param bool $flag
	 *        	[optional] page class applied to <li> element
	 *        	Default is true.
	 ...
	 *
	 * @param string|array $partial
	 *        	partial view script or null. If an array is
