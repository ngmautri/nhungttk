 ...
 */
abstract class AbstractAction extends Pdf\InternalStructure\NavigationTarget implements Countable, RecursiveIterator {
	/**
	 * Action dictionary
	 *
	 ...
	 *        	list of already processed action dictionaries,
	 ...
	 * @internal
	 *
	 * @param \ZendPdf\InternalType\AbstractTypeObject $dictionary
	 ...
	 * @param SplObjectStorage $processedActions
	 *        	list of already processed actions
