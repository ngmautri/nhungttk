...
abstract class AbstractAnnotation {
	...
	public function __construct(InternalType\AbstractTypeObject $annotationDictionary) {
		...
		if (count ( $this->_annotationDictionary->Rect->items ) != 4 || $this->_annotationDictionary->Rect->items [0]->getType () != InternalType\AbstractTypeObject::TYPE_NUMERIC || $this->_annotationDictionary->Rect->items [1]->getType () != InternalType\AbstractTypeObject::TYPE_NUMERIC || $this->_annotationDictionary->Rect->items [2]->getType () != InternalType\AbstractTypeObject::TYPE_NUMERIC || $this->_annotationDictionary->Rect->items [3]->getType () != InternalType\AbstractTypeObject::TYPE_NUMERIC) {
