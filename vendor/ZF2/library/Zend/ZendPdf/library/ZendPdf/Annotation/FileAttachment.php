...
class FileAttachment extends AbstractAnnotation {
	...
	public function __construct(InternalType\AbstractTypeObject $annotationDictionary) {
		...
		if ($annotationDictionary->Subtype === null || $annotationDictionary->Subtype->getType () != InternalType\AbstractTypeObject::TYPE_NAME || $annotationDictionary->Subtype->value != 'FileAttachment') {
