...
class Markup extends AbstractAnnotation {
	...
	public function __construct(InternalType\AbstractTypeObject $annotationDictionary) {
		...
		if ($annotationDictionary->Subtype === null || $annotationDictionary->Subtype->getType () != InternalType\AbstractTypeObject::TYPE_NAME || ! in_array ( $annotationDictionary->Subtype->value, array (
