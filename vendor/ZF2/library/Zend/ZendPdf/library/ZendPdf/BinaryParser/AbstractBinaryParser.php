...
abstract class AbstractBinaryParser {
	 ...
	 * @throws \ZendPdf\Exception\ExceptionInterface
	 */
	public function readFixed($mantissaBits, $fractionBits, $byteOrder = self::BYTE_ORDER_BIG_ENDIAN) {
	 ...
	 * @throws \ZendPdf\Exception\ExceptionInterface
	 */
	public function readStringUTF16($byteCount, $byteOrder = self::BYTE_ORDER_BIG_ENDIAN, $characterSet = '') {
		if ($byteCount == 0) {
			return '';
		}
