 ...
 */
abstract class AbstractOutline implements Countable, RecursiveIterator {
	/**
	 ...
	 * @param \ZendPdf\InternalType\AbstractTypeObject $parent
	 *        	Parent outline dictionary reference
	 * @param \ZendPdf\InternalType\AbstractTypeObject $prev
	 ...
	 */
	abstract public function dumpOutline(ObjectFactory $factory, $updateNavigation, InternalType\AbstractTypeObject $parent, InternalType\AbstractTypeObject $prev = null, \SplObjectStorage $processedOutlines = null);
