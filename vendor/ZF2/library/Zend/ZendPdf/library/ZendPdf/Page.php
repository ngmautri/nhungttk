...
class Page {
	 ...
	 *
	 * @var \ZendPdf\InternalType\DictionaryObject | \ZendPdf\InternalType\IndirectObject
	...
	public function __construct($param1, $param2 = null, $param3 = null) {
		if (($param1 instanceof InternalType\IndirectObjectReference || $param1 instanceof InternalType\IndirectObject) && $param1->getType () == InternalType\AbstractTypeObject::TYPE_DICTIONARY && $param2 instanceof ObjectFactory && $param3 === null) {
			...
			return;
		} elseif (is_string ( $param1 ) && ($param2 === null || $param2 instanceof ObjectFactory) && $param3 === null) {
			if ($param2 !== null) {
				$this->_objFactory = $param2;
			} else {
		 ...
		 */
		} elseif (is_numeric ( $param1 ) && is_numeric ( $param2 ) && ($param3 === null || $param3 instanceof ObjectFactory)) {
			if ($param3 !== null) {
	...
	public function extractFonts() {
		...
		foreach ( $fontResources->getKeys () as $fontResourceName ) {
			...
			if (! ($fontDictionary instanceof InternalType\IndirectObjectReference || $fontDictionary instanceof InternalType\IndirectObject)) {
	 ...
	 *
	 * @param float $x
	 *        	X-coordinate for the middle of the circle
	 * @param float $y
	 *        	Y-coordinate for the middle of the circle
	 * @param float $radius
	 *        	Radius of the circle
	 * @param float $startAngle
	 *        	Starting angle of the circle in radians
	 * @param float $endAngle
	 *        	Ending angle of the circle in radians
	 ...
	 *      
	 * @param float $x1
	 *        	X-coordinate of left upper corner of the ellipse
	 * @param float $y1
	 *        	Y-coordinate of left upper corner of the ellipse
	 * @param float $x2
	 *        	X-coordinate of right lower corner of the ellipse
	 * @param float $y2
	 *        	Y-coordinate of right lower corner of the ellipse
	 * @param float $startAngle
	 *        	Starting angle of the ellipse in radians
	 * @param float $endAngle
	 *        	Ending angle of the ellipse in radians
	 * @return \ZendPdf\Page Fluid interface
	 */
	 ...
	 * @return \ZendPdf\Page
	 */
	public function drawPolygon($x, $y, $fillType = self::SHAPE_DRAW_FILL_AND_STROKE, $fillMethod = self::FILL_METHOD_NON_ZERO_WINDING) {
		$this->_addProcSet ( 'PDF' );
	...
	public function getHeight() {
		return $this->_pageDictionary->MediaBox->items [3]->value - $this->_pageDictionary->MediaBox->items [1]->value;
	}
	...
	public function getWidth() {
		return $this->_pageDictionary->MediaBox->items [2]->value - $this->_pageDictionary->MediaBox->items [0]->value;
	}
