...
class PdfDocument {
	 ...
	 *
	 * @param \ZendPdf\InternalType\IndirectObjectReference $root
	...
	public function setNamedDestination($name, $destination = null) {
		if ($destination !== null && ! $destination instanceof Action\GoToAction && ! $destination instanceof Destination\AbstractExplicitDestination) {
	 ...
	 *
	 * @param \ZendPdf\Destination\AbstractDestination $destination
