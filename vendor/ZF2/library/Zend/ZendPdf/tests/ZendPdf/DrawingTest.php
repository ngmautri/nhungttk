...
class DrawingTest extends \PHPUnit_Framework_TestCase {
	...
	public function testDrawing() {
		...
		// Draw rectangle
		$page2->setFillColor ( new Color\GrayScale ( 0.8 ) )->setLineColor ( new Color\GrayScale ( 0.2 ) )->setLineDashingPattern ( array (
				3,
				2,
				3,
				4 
		), 1.6 )->drawRectangle ( 60, 400, 500, 350 );
		...
		// Draw rectangle
		$page3->setFillColor ( new Color\GrayScale ( 0.8 ) )->setLineColor ( new Color\GrayScale ( 0.2 ) )->setLineDashingPattern ( array (
				3,
				2,
				3,
				4 
	...
	public function testFontDrawing() {
		...
		foreach ( $fontsList as $fontName ) {
			...
			$page->setFont ( $titleFont, 10 )->drawText ( $font->getFontName ( Pdf\Font::NAME_POSTSCRIPT, 'en' ) . ':', 100, 400 );
		...
		$nonAlphabeticalPhonts = array (
				Pdf\Font::FONT_SYMBOL => "",
				Pdf\Font::FONT_ZAPFDINGBATS => "\x00\x20\x27\x01\x27\x02\x27\x03\x27\x04\x26\x0e\x27\x06\x27\x07\x27\x08\x27\x09\x26\x1b\x26\x1e\x27\x0c\x27\x0d\x27\x0e\x27\x0f\x27\x10\x27\x11\x27\x12\x27\x13\x27\x14\x27\x15\x27\x16\x27\x17\x27\x18\x27\x19\x27\x1a" 
		);
		foreach ( $nonAlphabeticalPhonts as $fontName => $example ) {
			...
			$page->setFont ( $font, 20 )->drawText ( $example, 100, 360, 'UTF-16BE' );
