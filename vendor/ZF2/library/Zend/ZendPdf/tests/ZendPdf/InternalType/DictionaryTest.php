...
class DictionaryTest extends \PHPUnit_Framework_TestCase {
	...
	public function testPDFDictionaryBadInput2() {
		$this->setExpectedException ( '\ZendPdf\Exception\RuntimeException', 'must be \ZendPdf\InternalType\AbstractTypeObject' );
	...
	public function testToString() {
		...
		$dictionaryObj = new InternalType\DictionaryObject ( $srcArray );
		$this->assertEquals ( $dictionaryObj->toString (), '<</Bool false /Number 100.426 /Name /MyName /Text (some text) /BinaryText <010200FF> >>' );
	}
