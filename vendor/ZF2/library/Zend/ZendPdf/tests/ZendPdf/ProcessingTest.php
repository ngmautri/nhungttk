...
class ProcessingTest extends \PHPUnit_Framework_TestCase {
	...
	public function testModify() {
		...
		foreach ( $pdf->pages as $page ) {
			...
			// Create new Style
			$page->setFillColor ( new Color\Rgb ( 0, 0, 0.9 ) )->setLineColor ( new Color\GrayScale ( 0.2 ) )->setLineWidth ( 3 )->setLineDashingPattern ( array (
					3,
					2,
					3,
					4 
			), 1.6 )->setFont ( Pdf\Font::fontWithName ( Pdf\Font::FONT_HELVETICA_BOLD ), 32 );
